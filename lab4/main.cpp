				 ...
				 int repetitions, Vector v1[], Vector v2[])
{
    ...
    for (int i = 0; i < 3; ++i)
    {
    	...
    	add = get_average_time(add_SISD, v1, v2, nums_in_array, repetitions);
    	sub = get_average_time(sub_SISD, v1, v2, nums_in_array, repetitions);
    	mul = get_average_time(mul_SISD, v1, v2, nums_in_array, repetitions);
    	div = get_average_time(div_SISD, v1, v2, nums_in_array, repetitions);
...
int main() 
{
    ...
    // "heating up" CPU before saving
    generate_output(num_of_elements1, num_of_elements2, num_of_elements3,
				repetitions, v1, v2);
